...
response3 = requests.put('https://httpbin.org/put', data={'name': 'Makena'})
...
# for ex: https://httpbin.org/get?name=alicia
...
#print(r.url) # https://httpbin.org/get?name=Jake&age=30
...
my_dict = {'fruits': ['apple', 'mango'], 'destination': 'Lamu'}
r2 = requests.post('https://httpbin.org/post', params=my_dict)
#print(r2.url) # https://httpbin.org/post?fruits=apple&fruits=mango&destination=Lamu
